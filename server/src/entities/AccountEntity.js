exports.AccountEntity = class AccountEntity {
  ...
  validateEncryptedNotes(isRequired) {
    if (isRequired && !this.encryptedNotes) return "ACCOUNT_VALIDATION_031";
  ...
  validateNotesEncryptionIv(isRequired) {
    if (isRequired && !this.notesEncryptionIv) return "ACCOUNT_VALIDATION_034";
