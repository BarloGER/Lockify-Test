exports.ContactEntity = class ContactEntity {
  ...
  validateEncryptedNotes(isRequired) {
    if (isRequired && !this.encryptedNotes) return "CONTACT_VALIDATION_050";
  ...
  validateNotesEncryptionIv(isRequired) {
    if (isRequired && !this.notesEncryptionIv) return "CONTACT_VALIDATION_053";
